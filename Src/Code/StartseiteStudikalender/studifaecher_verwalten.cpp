...
void Studifaecher_verwalten::on_loeschen_clicked()
{
    ...
    switch(t){
      ...
      case QMessageBox::Yes:
        ...
        STD.DeleteStudienfach(id);

        break; }

}
//Studienfachbearbeitung speichern
void Studifaecher_verwalten::on_speichern_clicked()
{
    ...
    fach.UpdateStudienfach(id,Name,ects,sws,stunden);}
}
//Daten des ausgewählten Studienfachs in neues Fenster einsetzen
