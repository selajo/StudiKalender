...
//LöschFunktion
 bool Studienfach::DeleteStudienfach( int idStudienfach){
     QSqlQuery Query;
...
//UpdateFunktion
bool Studienfach::UpdateStudienfach(int idStudienfach, QString Name, int ECTS, int SWS, int Eigenstunden){
    QSqlQuery Query;
...
//Studienfachwerte in die Attribute laden
 bool Studienfach::StudienfachLaden( QString Name, int idNutzer_fk){
    QSqlQuery Query;
...
bool Studienfach::insert_Studienfach( QString Name, int ECTS, int SWS, int Eigenstunden, int idNutzer_fk){
...
//Liefert Werte von Studienfach
 bool Studienfach::StudienfachwertevonID( int ID){
    QSqlQuery Query;
