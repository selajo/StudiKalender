    ...
    ui(new Ui::Termin_erstellen)
{
    ...
    //aktuelle Uhrzeit und Datum eingeben
...
void Termin_erstellen::on_termin_hinzufuegen_clicked()
{
    ...
    this->close();
        ...
        //Termin so oft wie Wiederholung hinzufügen
        while(wdh!=-1){


            Termin Ter;
            Ter.TerminInsert( titel, datum, beginn, ende, beschreibung, reminder,erledigt, wdh , false, i);
            wdh--;
